 ...
 */
public class CoolWeatherHelpler extends SQLiteOpenHelper {
    ...
    public CoolWeatherHelpler(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
